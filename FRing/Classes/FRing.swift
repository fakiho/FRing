//  FRing.swift
//
//  Created by Ali Fakih on 1/9/19.
...
class FRing: UIView {
    ...
    public var labelSize: CGFloat = 20 {
        didSet {
            label.font = UIFont(name: "Futura-CondensedExtraBold", size: UIFont.systemFontSize)!
            label.sizeToFit()
            configLabel()
        }
    }
    ...
    private func drawBackgroundLayer(){
        let startAngle = (CGFloat.pi/2 + CGFloat.pi/4 )
        
        let endAngle = 2 * CGFloat.pi + startAngle - 2*CGFloat.pi/4
    ...
    private func configLabel(){
        ...
        let font = UIFont(name: "Futura-CondensedExtraBold", size: UIFont.systemFontSize)!
        label.font = font
    }
